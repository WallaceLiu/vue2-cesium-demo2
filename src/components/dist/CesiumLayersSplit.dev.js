...
exports.layerSplit = layerSplit;
exports.removeLayerSplit = removeLayerSplit;
...
function layerSplit(layerLeft, layerRight) {
  // 设置图层顺序
...
function removeLayerSplit(options) {
  if (_typeof(options) != 'object') {
    throw 'removeLayerSplit的参数必须是Object类型';
  }

  if (options.handler == undefined || options.slider == undefined || options.layerLeft == undefined) {
...
function createSliderDiv() {
  ...
  var parent = document.getElementsByClassName('cesium-viewer')[0].parentElement;
